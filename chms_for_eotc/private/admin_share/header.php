...
<head>
    ...
    <link rel="stylesheet"  href="<?php echo PRI_ROOT.'private/admin_share/style.css'?>">      
        ...
        <ul>
            <li><a href="<?php echo PRI_ROOT.'private/admin/suppletter.php';?>" class="">supportive letter</a></li>
             ...
             <div class="o1">
               <ul> view
                    <div class="i">
                        <li><a href="<?php echo PRI_ROOT.'private/admin/assgConf.php';?>" class="">confession father</a></li>
